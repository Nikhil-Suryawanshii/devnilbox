...
class UserRepository extends Repository
{
    ...
    /**
     * Generate access token without expiry for seller login.
     *
     * @param  User  $user  The user for whom the token is being obtained
     * @return array
     */
    public static function getAccessTokenWithoutExpiry(User $user)
    {
        $token = $user->createToken('seller_api_token')->plainTextToken;
