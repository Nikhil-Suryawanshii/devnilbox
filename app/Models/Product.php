...
class Product extends Model
{
    ...
    public function video(): Attribute
    {
        ...
        if ($this->videoMedia && $this->videoMedia->type == 'file' && Storage::disk('public')->exists($this->videoMedia->src)) {
            $video = (object) [
    ...
    public function thumbnail(): Attribute
    {
        return Attribute::make(
            get: function (): string {
                return \App\Support\PublicMedia::url($this->media?->src);
            }
        );
    }
    ...
    public function additionalAttachments(): Collection
    {
        ...
        foreach ($this->attachments as $attachment) {
            ...
            if ($attachment && Storage::disk('public')->exists($attachment->src)) {
                $file = Storage::disk('public')->url($attachment->src);
            }
            $attachments[] = (object) [
                'id' => $attachment?->id,
                'url' => $file,
    ...
    {
        return $this->hasMany(RecentView::class, 'product_id');
    }
}
