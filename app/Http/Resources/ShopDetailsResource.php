...
class ShopDetailsResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $followState = $this->follow_state ?? $this->followStateFor(auth('api')->user());
        ...
        return [
            ...
            'is_following' => (bool) ($followState['is_following'] ?? false),
            'is_liked' => (bool) ($followState['is_liked'] ?? false),
        ];
    }
}
