                            ...
                            <div class="col-lg-4 col-md-6 mt-4">
                              ...
                              <div class="col-md-6 col-lg-4 mt-4">
                                ...
                                <select 
                                    ...
                                    class="form-control sizeSelector"
                                    multiple
                                    style="width:100%"
                                >
...
@push('scripts')
    <script>
        ...
        $(document).ready(function() {
             // Auto-populate Meta Title and Meta Description
             $('#product_name').on('blur', function() {
                var name = $(this).val();
                $('input[name="meta_title"]').val(name);
            });

            $('#short_description').on('blur', function() {
                var shortDesc = $(this).val();
                $('textarea[name="meta_description"]').val(shortDesc);
            });
