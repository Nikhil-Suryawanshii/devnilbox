<template>
    <PublicLayout ref="publicLayoutRef">
        <div class="bg-orange-50/50 min-h-screen">
        <div class="main-container pt-32 pb-12">
        <div v-show="!isLoading" class="grid grid-cols-1 xl:grid-cols-4 gap-6">
            <div class="xl:col-span-3 col-span-1">
                <div class="bg-white rounded-[2rem] shadow-[0_20px_40px_-12px_rgba(0,0,0,0.08)] border border-white ring-1 ring-orange-100 p-6 sm:p-8 lg:p-10 transition-shadow duration-300 hover:shadow-[0_25px_50px_-10px_rgba(251,146,60,0.1)]">
                ...
                <div class="flex flex-wrap lg:flex-nowrap gap-4 mt-6">
                    ...
                    <div class="w-full sm:w-auto">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <!-- Add to Cart -->
                            <button 
                                class="grow max-w-56 justify-center items-center text-slate-900 flex gap-2 px-6 py-4 rounded-[10px] border border-slate-900 hover:bg-slate-50 transition-colors"
                                @click="publicLayoutRef?.openDownloadModal()">
                                <div class="w-5 h-5">
                                    <BagIcon />
                                </div>
                            ...
                            <!-- Buy Now -->
                            <button
                                class="grow text-white bg-slate-900 px-6 py-4 rounded-[10px] border border-slate-900 hover:bg-slate-800 transition-colors max-w-[50%]"
            ...
            <!-- Right side -->
            <div class="hidden xl:block col-span-1 w-full pl-6 pt-0">
                <ProductDetailsRightSide :product="product" :popularProducts="popularProducts" />
            </div>
        </div>
