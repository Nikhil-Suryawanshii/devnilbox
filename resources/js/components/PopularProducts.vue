<template>
    <div class="main-container py-12">
        ...
        <!-- Header -->
        <div v-if="!isLoading" class="flex justify-between items-center gap-4 relative">
            <!-- <div class=" text-slate-800 text-lg md:text-3xl font-bold leading-9">{{ $t('Popular Products') }}</div> -->

            <router-link to="/most-popular" class="flex items-center gap-1 mr-5">
                <div class="text-slate-600 mr-5 text-base font-normal leading-normal">{{ $t('View All') }}</div>
