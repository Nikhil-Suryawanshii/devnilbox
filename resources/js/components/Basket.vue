<template>
    <div class="space-y-4">
        ...
        <div v-for="shop in basketStore.products" :key="shop.shop_id" class="border border-slate-100 rounded-xl">
            ...
            <div class="p-4 flex flex-col gap-3">
                <div v-for="product in shop.products" :key="product.cart_id ?? product.id">
...
onMounted(() => {
    basketStore.onCartItemsUpdated();
