...
const setupThemeColors = () => {
    const c = master.themeColors;
    if (!c?.primary) {
        return;
    }
    document.documentElement.style.setProperty('--primary', c.primary);
    document.documentElement.style.setProperty('--primary-50', c.primary50);
    document.documentElement.style.setProperty('--primary-100', c.primary100);
    document.documentElement.style.setProperty('--primary-200', c.primary200);
    document.documentElement.style.setProperty('--primary-300', c.primary300);
    document.documentElement.style.setProperty('--primary-400', c.primary400);
    document.documentElement.style.setProperty('--primary-500', c.primary500);
    document.documentElement.style.setProperty('--primary-600', c.primary600);
    document.documentElement.style.setProperty('--primary-700', c.primary700);
    document.documentElement.style.setProperty('--primary-800', c.primary800);
    document.documentElement.style.setProperty('--primary-900', c.primary900);
    document.documentElement.style.setProperty('--primary-950', c.primary950);
};

const applyLandingThemeFallback = () => {
...
onMounted(() => {
    applyLandingThemeFallback();
    master.fetchData();
    setupThemeColors();
});

watch(() => master.themeColors, setupThemeColors, { deep: true });
