...
Route::post('/social-login', [SocialAuthController::class, 'firebaseSocialLogin']);
...
Route::controller(AuthController::class)->group(function () {
    Route::post('/registration', 'register')->name('api.registration');
...
Route::controller(SubCategoryController::class)->group(function () {
    ...
    Route::get('/sizes-by-subcategory', 'getSizesBySubCategory');
});

// category products route
Route::get('/category-products', [ProductController::class, 'index']);

// product route (optional auth so wishlist state loads on public pages)
Route::middleware('optional.sanctum')->controller(ProductController::class)->group(function () {
    Route::get('/products', 'index');
    Route::get('/product-details', 'show');
    Route::post('/product/update-favorite-count', 'updateFavoriteCount');
    Route::post('/product/increment-share-count', 'incrementShareCount');
});
// review route
...
Route::middleware(['auth:sanctum', 'role:customer'])->group(function () {
    ...
    // shop follow routes
    Route::controller(ShopFollowController::class)->group(function () {
        Route::post('/shop/follow-toggle', 'followToggle');
                Route::post('/shop/like-dislike', 'likeDislike');
        Route::get('/shop/is-following', 'isFollowing');
        Route::get('/shop/followers', 'followers');
        Route::get('/following-shops', 'followingShops');
    });
    ...
    Route::get('/get-shops/search', [ChatController::class, 'getShops']);
    Route::get('/get-shop/search', [ChatController::class, 'getShops']);
    ...
    Route::post('/block-seller', [ChatController::class, 'blockSeller']);
    Route::post('/unblock-seller', [ChatController::class, 'unblockSeller']);
...
Route::middleware('auth:sanctum')->prefix('ai')->controller(AiController::class)->group(function () {
    Route::post('/chat', 'chat');
    Route::post('/product-analyze', 'productAnalyze');
});
