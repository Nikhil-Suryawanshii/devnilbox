...
use App\Http\Controllers\Gateways\PayPal\ProcessController as PayPalProcessController;
...
Route::controller(PaymentGatewayController::class)->group(function () {
   ...
   // Route::post('/payment/{payment}/callback-cancel', 'cancel')->name('payment.cancel');
    ...
    Route::match(['get', 'post'], '/payment/{payment}/callback-success', 'success')
    ->name('payment.success');

    Route::match(['get', 'post'], '/payment/{payment}/callback-cancel', 'cancel')
        ->name('payment.cancel');
