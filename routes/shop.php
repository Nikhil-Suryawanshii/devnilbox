...
use App\Http\Controllers\Shop\BankAccountController;
...
Route::name('shop.')->group(function () {
    ...
    Route::middleware(['authShop', 'checkPermission'])->group(function () {
        ...
        Route::controller(BankAccountController::class)->group(function () {
            Route::get('/bank-accounts', 'index')->name('bank-account.index');
            Route::get('/bank-account/create', 'create')->name('bank-account.create');
            Route::post('/bank-account/store', 'store')->name('bank-account.store');
            Route::get('/bank-account/{bankAccount}/show', 'show')->name('bank-account.show');
            Route::get('/bank-account/{bankAccount}/edit', 'edit')->name('bank-account.edit');
            Route::put('/bank-account/{bankAccount}/update', 'update')->name('bank-account.update');
            Route::put('/bank-account/{bankAccount}/make-primary', 'makePrimary')->name('bank-account.makePrimary');
            Route::get('/bank-account/{bankAccount}/destroy', 'destroy')->name('bank-account.destroy');
        ...
        Route::get('/customer-chats', [ChatController::class, 'index'])->name('customer.chat.index');
        Route::get('/get-users', [ChatController::class, 'getUsers']);
        Route::get('/get-message', [ChatController::class, 'getMessageAdmin']);
        Route::post('/send-message', [ChatController::class, 'sendMessageAdmin']);
